...
function add() {
	...
	car1_im1gTag = new Image(); //define una variable con una nueva imagen
...
function car1_up()
{
    if(car1_y >=0)
    {
		...
		car1_y = car1_y - 10;
		console.log("cuando se precione la flecha arriba,  x =" + car1_x + " | y = " + car1_y);
        uploadBackground();
        uploadcar1();
        uploadcar2();
	}
...
function car1_down()
{
    if(car1_y <=500)
    {
		...
		car1_y = car1_y + 10;
		console.log("cuando se precione la flecha abajo,  x =" + car1_x + " | y = " +car1_y);
        uploadBackground();
        uploadcar1();
        uploadcar2();
	}
...
function car1_right()
{
    if(car1_x <=700)
    {
		...
		car1_x = car1_x + 10;
		console.log("cuando se precione la flecha derecha,  x =" + car1_x + " | y = " + car1_y);
        uploadBackground();
        uploadcar1();
        uploadcar2();
	}
...
{
    console.log("car1")
    document.getElementById('game_status').innerHTML = "!gana el auto 1h"
}
